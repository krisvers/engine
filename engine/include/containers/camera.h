...
camera_t KAPI * camera_create(f32 fov, f32 near, f32 far);
...
camera_t KAPI * ortho_camera_create(float left, float right, float bottom, float top, float near, float far);
