...
b8 vulkan_renderer_backend_frame_begin(renderer_backend_t * backend, render_packet_t * packet);
b8 vulkan_renderer_backend_frame_end(renderer_backend_t * backend, render_packet_t * packet);
